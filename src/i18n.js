...
const resources = {
  en: {
    translation: {
      ...
      'who': 'Who are we?',
      'Desc': `The Listen-Quran project is produced by young Uzbek programmers and currently works only in Arabic-Uzbek, Arabic-English. The project is currently running in <span> Beta </span> <code> 0.9 </code>. Subsequent versions of the project are also being developed by developers, and a <span> Stable </span> version of the project will soon be available for fans. If you want contribute Join our <a href="https://github.com/BlackArcheruz/listen-quran">Github!</a>. *Now We added listen by verses, but we have only Mishary Al Afasy for verses.`,
  ...
  uz_cyril:{
    ...
    'who': 'Биз киммиз?',
    'Desc': `Listen-Quran лойиҳаси Ўзбекистонлик ёш дастурчилар томонидан ишлаб чиқилган бўлиб, лойиҳа ҳозирда фақат Араб-Ўзбек, Араб-Инглиз тилларида ишламоқда. Лойиҳа ҳозирда <span>Beta</span> <code>0.9</code> версиясида ишга туширилган. Лойиҳанинг кейинги версиялари ҳам дастурчилар томонидан ишлаб чиқилмоқда ва тез орада Қуръон мухлислари учун лойиҳанинг <span>Stable</span> версияси ҳам тақдим этилади. Агарда лойиҳага ўз ҳиссангизни қўшмоқчи бўлсангиз бизнинг лойиҳанинг <a href="https://github.com/BlackArcheruz/listen-quran">Github</a>даги саҳифасига қўшилинг ва Қуръон илмини улашиш мақсадида бизга қўшилинг! * Ҳозирда оятма оят ўқиш ҳолати фақат Мишари ал Афасий асосида ишламоқда`,
