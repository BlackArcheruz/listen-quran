...
const resources = {
  en: {
    translation: {
      ...
      'who': 'Who are we?',
      'Desc': `The Listen-Quran project is produced by young Uzbek programmers and currently works only in Arabic-Uzbek, Arabic-English. The project is currently running in <span> Beta </span> <code> 0.8 </code>. Subsequent versions of the project are also being developed by developers, and a <span> Stable </span> version of the project will soon be available for fans. If you want contribute Join our <a href="https://github.com/BlackArcheruz/listen-quran">Github!</a>. *Now We added listen by verses, but we have only Mishary Al Afasy for verses.`,
