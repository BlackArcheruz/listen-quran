  ...
  const [t,i18n] = useTranslation()
    ...
    return(
        ...
        <Menu right bubble styles={styles} > 
                ...
                <a href="https://namozvaqtlari1.netlify.app/" id="tasbeh" className="menu-item" style={{display: "flex",alignItems: "center", justifyContent:'flex-start', margin: "1rem 0", fontWeight: "600", fontSize: "1.15em", color: (props.theme === 'dark' ? "#f1f1f1" : "#121620")}}><Timer variant={props.theme === "dark"? 'Linear' : 'Bold'} color={props.theme === "dark"? "#f1f1f1": "#121620"} style={{marginRight: '5px'}}/> {t('namoz')}</a> 
